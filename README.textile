...
It tries to call @current_user@ method as the rater instance. If it's nil then the stars
will not be _linkeables_.
...
You can specify a custom user instance by passing it as parameter.
...
The helper's style is from http://www.komodomedia.com/blog/2007/01/css-star-rating-redux/ with author's permission.
